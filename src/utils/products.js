...
export const SliderData = [
  {
      ...
      desc: "From cart to heart – Your favorite products are just a tap away!",
      cover: sofaSlide,
  },
  {
      id: 2,
      title: "50% Off For Your First Shopping",
      desc: "Swipe, shop, repeat – Never miss a beat!",
      cover: phone08,
  },
  {
      id: 3,
      title: "50% Off For Your First Shopping",
      desc: "Fashion-forward, wallet-friendly – Unleash the shopaholic in you!",
      cover: wireless01,
  },
  {
      id: 4,
      title: "50% Off For Your First Shopping",
      desc: "Deals that thrill, shopping made chill!",
      cover: watchSlide,
  },
];
...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Float away on cloud nine with Free Shipping every time",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Safe Payments, Secure Smiles - Shop with peace of mind!",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Secure Payment",
    subtitle: "Free Shipping, Safe Payments - Your shopping sanctuary awaits!",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: " Back Guarantee",
    subtitle: "Risk-Free Retail Therapy - We've got you covered!",
    bg: "#d6e5fb",
  },
];
